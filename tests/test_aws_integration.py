...
def create_mock_customer_environment():
    ...
    daily_plan = backup.create_backup_plan(
        BackupPlan={
    ...
    weekly_plan = backup.create_backup_plan(
        BackupPlan={
    ...
    monthly_plan = backup.create_backup_plan(
        BackupPlan={
    ...
    try:
        ...
        backup_role_arn = f"arn:aws:iam::123456789012:role/aws-backup-service-role"
